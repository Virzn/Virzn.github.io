...
/*
params: {id: '1', name: 'Leo', age: '33'}
pathname: "/hello/message/detail/1/Leo/33"
pathnameBase: "/hello/message/detail/1/Leo/33"
...
```jsx
const res = useResolvedPath('/user?id=001&name=Leo#React')
console.log(res)

/*
hash: '#React'
pathname: '/user'
search: '?id=001&name=Leo'
*/
```
